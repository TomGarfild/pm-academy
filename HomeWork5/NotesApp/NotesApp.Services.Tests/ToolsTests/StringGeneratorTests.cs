...
namespace NotesApp.Tests.ToolsTests
{
    ...
    {
        [Fact]
        public void GenerateNumbersString_Should_Return_Empty_String_If_Length_Equal_Zero()
        {
        ...
        [Fact]
        public void GenerateNumbersString_Should_Return_String_Without_Leading_Zero()
        {
            Assert.NotEqual('0', StringGenerator.GenerateNumbersString(2, false)[0]);
        }

        [Fact]
        public void GenerateNumberString_Should_Return_String_With_Set_Length()
        {
            var length = 100;
        ...
        [Fact]
        public void GenerateNumberString_Should_Return_String_That_Is_Number_With_Set_Length()
        {
            var length = 15;
