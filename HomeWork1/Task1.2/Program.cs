...
namespace Task12
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine();
            Console.WriteLine($"Chance of {name1}'s victory: {Math.Round(100 * (firstChance - margin/3), 1)}%");
            Console.WriteLine($"Chance of {name2}'s victory: {Math.Round(100 * (secondChance - margin / 3), 1)}%");
            Console.WriteLine($"Chance of draw: {Math.Round(100 * (drawChance - margin / 3), 1)}%");
